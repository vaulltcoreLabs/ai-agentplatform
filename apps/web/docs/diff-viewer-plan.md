...
- `createEditDiffLines` from `@vaulltcore/shared/lib/diff` - adapt for unified diff parsing
...
- `@vaulltcore/sandbox` for `connectVercelSandbox`
- `@vaulltcore/shared/lib/diff` for diff utilities
