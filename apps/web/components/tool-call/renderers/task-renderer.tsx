import type { TaskPendingToolCall } from "@vaulltcore/agent";
import { formatTokens, toRelativePath } from "@vaulltcore/shared";
import type { ToolRenderState } from "@vaulltcore/shared/lib/tool-state";
import {
  Bot,
  FileText,
  FilePlus,
