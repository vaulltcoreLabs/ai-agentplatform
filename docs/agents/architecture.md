...
This is a Turborepo monorepo for "Vaulltcore" - an AI coding agent built with AI SDK.
...
apps/
  web/           # Web interface
packages/
  agent/         # Core agent logic (@vaulltcore/agent)
  sandbox/       # Sandbox abstraction (@vaulltcore/sandbox)
  shared/        # Shared utilities (@vaulltcore/shared)
